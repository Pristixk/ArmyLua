...
EXPORTS = {
    colorThemes = {"Синяя[1]", "Красная[2]", "Темно-зеленая[3]", "Аква[4]", "Чёрная[5]", "Фиолетовая[6]", "Черно-оранжевая[7]", "Монохром[8]", "Вишневая[9]", "Темно-красная[10]", "Гламурно-розовая[11]"},
